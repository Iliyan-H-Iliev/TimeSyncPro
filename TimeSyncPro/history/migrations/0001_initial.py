    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['content_type', 'object_id'], name='history_his_content_774c23_idx'), models.Index(fields=['timestamp'], name='history_his_timesta_1d8a61_idx'), models.Index(fields=['action'], name='history_his_action_75f098_idx')],
            },
        ),
    ]
