...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='absence',
            options={'ordering': ['start_date'], 'permissions': [('view_all_absences', 'Can view all absences'), ('view_department_absences', 'Can view department absences'), ('view_team_absences', 'Can view own absences'), ('view_absences', 'Can view absences')]},
        ),
        migrations.AlterModelOptions(
            name='holiday',
