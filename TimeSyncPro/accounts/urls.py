...
urlpatterns = [
    ...
    path('users/<slug:slug>/', include([
        ...
        path("profile/", include([
            ...
            path("edit/", views.BasicEditProfileView.as_view(), name="update_profile"),
            path("detailed-edit/", views.DetailedOwnEditProfileView.as_view(), name="detailed_update_own_profile"),
        ])),
    ])),
