    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_company_admin', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('role', models.CharField(blank=True, choices=[('Staff', 'Staff'), ('Team Leader', 'Team Leader'), ('Manager', 'Manager'), ('HR', 'HR')], default='Staff', max_length=11, null=True)),
                ('date_of_hire', models.DateField(blank=True, null=True, validators=[TimeSyncPro.accounts.validators.DateRangeValidator])),
                ('days_off_left', models.PositiveSmallIntegerField(blank=True, default=0, null=True)),
