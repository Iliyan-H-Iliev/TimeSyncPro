...
def render_field(field, **kwargs):
    try:
        ...
        if isinstance(field.field, Field):
            ...
            is_readonly = (
                field.name in getattr(field.form, "readonly_fields", [])
                or getattr(field.field.widget, "readonly", False)
                or field.field.widget.attrs.get("readonly")
                or field.field.widget.attrs.get("disabled")
            )
